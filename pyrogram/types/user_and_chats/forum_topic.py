...
class ForumTopic(Object):
    ...
    Parameters:
        ...
        from_id (:obj:``Union[types.PeerChannel, types.PeerUser]``):
            Topic creator.

        #notify_settings (:obj:``types.PeerNotifySettings``): //todo
            N/A
        ...
        #draft (:obj:``types.DraftMessage``): //todo
            N/A
    ...
    def __init__(
        ...
        *,
        ...
        #notify_settings  # PeerNotifySettings //todo
        my: bool = None,
        closed: bool = None,
        pinned: bool = None,
        short: bool = None,
        icon_emoji_id: int = None
        #draft  # flags.4?DraftMessage //todo
    ):
        super().__init__()
    ...
    def _parse(forum_topic: "raw.types.forum_topic") -> "ForumTopic":
        ...
        return ForumTopic(
            ...
            from_id=peer,
            #notify_settings=getattr(forum_topic,"", None),
            ...
            #draft=getattr(forum_topic,"", None),
        )
